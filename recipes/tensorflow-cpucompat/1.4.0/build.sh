...
bazel build --incompatible_disallow_set_constructor=false --define PREFIX=${PREFIX} --local_resources 2048,4,1.0 -c opt --copt=-mfpmath=both //tensorflow/tools/pip_package:build_pip_package
