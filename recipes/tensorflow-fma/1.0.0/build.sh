...
bazel build --define PREFIX=${PREFIX} --local_resources 4096,4,1.0 -c opt --copt=-mfma --copt=-mavx --copt=-mfpmath=both --copt=-msse4.2  //tensorflow/tools/pip_package:build_pip_package
